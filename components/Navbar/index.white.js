...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className={styles.backdropShade} style={{background: "rgba(255, 255, 255, 0.2) !important"}} ref={backdropShade}></div>
      <div className={styles.navbarWrapper}>
        ...
        <div className={styles.hamburger} ref={hamburger}>
          <div className={styles.hamburgerList1} style={{background: "#fff"}} ref={hamburgerStick1}></div>
          <div className={styles.hamburgerList2} style={{background: "#fff"}} ref={hamburgerStick2}></div>
          <div className={styles.hamburgerList3} style={{background: "#fff"}} ref={hamburgerStick3}></div>
        </div>
      </div>
